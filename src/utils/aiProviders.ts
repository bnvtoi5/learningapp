    ...
    models: [
      {
        ...
        provider: 'custom',
        description: 'Mô hình Sonnet 5 thế hệ mới, cân bằng hoàn hảo giữa tốc độ và trí tuệ.',
        badge: '⚡ Khuyên dùng',
        tagColor: 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20',
        isPopular: true,
      },
      {
        ...
        name: 'Claude Opus 5',
        provider: 'custom',
        description: 'Mô hình Opus 5 cao cấp nhất, năng lực lý luận và phân tích sâu sắc.',
        badge: '🧠 Đỉnh cao',
        tagColor: 'bg-purple-500/10 text-purple-500 border-purple-500/20',
        isPopular: true,
      },
      {
        ...
        provider: 'custom',
        description: 'Phản hồi siêu tốc với chi phí tối ưu, thích hợp đàm thoại nhanh.',
        badge: '🚀 Siêu tốc',
        tagColor: 'bg-blue-500/10 text-blue-500 border-blue-500/20',
      },
      {
        ...
        name: 'Claude Opus 4.8',
        provider: 'custom',
        description: 'Mô hình Opus 4.8 năng lực tư duy chuyên sâu.',
        badge: '🧠 Cao cấp',
        tagColor: 'bg-amber-500/10 text-amber-500 border-amber-500/20',
      },
      {
        ...
        provider: 'custom',
        description: 'Mô hình Sonnet 4.6 ổn định và chuẩn xác.',
        badge: '🎯 Chuẩn xác',
        tagColor: 'bg-teal-500/10 text-teal-500 border-teal-500/20',
      },
      {
